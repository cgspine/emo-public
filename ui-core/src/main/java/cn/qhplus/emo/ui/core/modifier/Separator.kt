...
fun Modifier.topSeparator(
    ...
    drawTopSeparator(color, insetStart, insetEnd)
}
...
fun Modifier.rightSeparator(
    ...
    drawRightSeparator(color, insetStart, insetEnd)
}
...
fun Modifier.bottomSeparator(
    ...
    drawBottomSeparator(color, insetStart, insetEnd)
}
...
fun Modifier.leftSeparator(
    ...
    drawLeftSeparator(color, insetStart, insetEnd)
}
